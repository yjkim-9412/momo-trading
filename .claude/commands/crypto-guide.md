...
| `CODEX_MODEL` | `CRYPTO_CODEX_MODEL` | Codex 기본 모델 (fallback) |
| `CODEX_MODEL_TIER1` | `CRYPTO_CODEX_MODEL_TIER1_SCAN` / `_ANALYSIS` | Codex 모델 (스캔/분석 분리) |
| `CODEX_MODEL_TIER2` | `CRYPTO_CODEX_MODEL_TIER2` | Codex 검토 모델 |
